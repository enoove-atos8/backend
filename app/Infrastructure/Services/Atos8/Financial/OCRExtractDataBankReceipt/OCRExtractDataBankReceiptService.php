...
class OCRExtractDataBankReceiptService
{
    ...
    public function ocrExtractData(array $arrFilePath, string $docType, string $docSubType): array | string | bool
    {
        $dataExtracted = $this->getBankingInstitution($arrFilePath);
        return $this->receiptModelByInstitution->handleDispatchDataFunctionByInstitution($dataExtracted, $docType, $docSubType);
    }
