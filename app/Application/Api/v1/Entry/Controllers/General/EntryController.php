...
namespace Application\Api\v1\Entry\Controllers\General;

use Application\Api\v1\Entry\Requests\EntryRequest;
use Application\Api\v1\Entry\Requests\ReceiptEntryRequest;
...
use Domain\Entries\Consolidated\Actions\GetConsolidatedEntriesByStatusAction;
use Domain\Entries\Consolidated\Actions\GetQtdEntriesNoCompensateByMonthAction;
use Domain\Entries\Consolidated\Actions\UpdateStatusConsolidatedEntriesAction;
use Domain\Entries\Consolidated\Constants\ReturnMessages as ConsolidationEntriesReturnMessages;
use Domain\Entries\General\Actions\CreateEntryAction;
use Domain\Entries\General\Actions\DeleteEntryAction;
use Domain\Entries\General\Actions\GetAmountByEntryTypeAction;
use Domain\Entries\General\Actions\GetEntriesAction;
use Domain\Entries\General\Actions\GetEntryByIdAction;
use Domain\Entries\General\Actions\UpdateEntryAction;
