...
namespace Infrastructure\Repositories\Entries\Consolidated;
...
use Domain\Entries\Consolidated\Models\ConsolidationEntries;
use Illuminate\Contracts\Container\BindingResolutionException;
use Illuminate\Database\Eloquent\Model;
use Illuminate\Support\Collection;
use Infrastructure\Repositories\BaseRepository;

class ConsolidatedEntriesRepository extends BaseRepository implements ConsolidatedEntriesRepositoryInterface
{
    ...
    public function getEntriesEvolutionConsolidation(string $consolidatedValues = '*', int $limit = 6): Collection
    {
        ...
        if($consolidatedValues != '*')
        {
            $this->queryClausesAndConditions['where_clause']['clause'][] = [
                'type' => 'and',
                'condition' => ['field' => ConsolidatedEntriesRepository::CONSOLIDATED_COLUMN,
