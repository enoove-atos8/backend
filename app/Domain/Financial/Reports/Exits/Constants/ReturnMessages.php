...
namespace App\Domain\Financial\Reports\Exits\Constants;
...
class ReturnMessages
{
    ...
    public const EXTRACT_NOT_PROCESSED = 'O extrato bancário ainda não foi processado. Inicie ou aguarde o processamento antes de gerar o relatório de saídas!';
