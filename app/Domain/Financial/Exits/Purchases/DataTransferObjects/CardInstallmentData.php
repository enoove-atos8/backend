    ...
    public static function fromResponse(array $data): self
    {
        return new self(
            ...
            cardPurchaseData: new CardPurchaseData([
                'id' => $data['cards_purchase_id'] ?? null,
                'cardId' => $data['cards_purchase_card_id'] ?? null,
                'status' => $data['cards_purchase_status'] ?? null,
                'amount' => isset($data['cards_purchase_amount']) ? (float) $data['amount'] : null,
                'installments' => $data['cards_purchase_installments'] ?? null,
                'installmentAmount' => $data['cards_purchase_installment_amount'] ?? null,
                'date' => $data['cards_purchase_date'] ?? null,
                'deleted' => $data['cards_purchase_deleted'] ?? false,
                'receipt' => $data['cards_purchase_receipt'] ?? null,
            ]),
