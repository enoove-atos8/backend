...
class ReceiptDataRequest extends FormRequest
{
    ...
    public function syncStorageData(): SyncStorageData
    {
        return new SyncStorageData(
            ...
            accountId:                              $this->integer('accountId'),
            originAccountId:                        $this->integer('originAccountId'),
            destinationAccountId:                   $this->integer('destinationAccountId'),
            ...
            isGroupDevolution:                      $this->boolean('isGroupDevolution'),
