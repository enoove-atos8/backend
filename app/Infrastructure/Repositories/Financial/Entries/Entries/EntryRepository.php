    ...
    */
    ...
    public function getHistoryTitheByMemberId(int $memberId, int $months = 6): array
    {
        $query = function () use ($memberId, $months) {
            // Verifica se este membro é dependente de outro
            ...
            // Sempre busca os dízimos do próprio membro (não do principal)
            // Se for dependente e o mês for false = bolinha amarela (dízimo do titular)
            // Se for dependente e o mês for true = bolinha verde (ele mesmo dizimou)
