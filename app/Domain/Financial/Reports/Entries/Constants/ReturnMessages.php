...
namespace App\Domain\Financial\Reports\Entries\Constants;
...
class ReturnMessages
{
    ...
    public const EXTRACT_NOT_PROCESSED = 'O extrato bancário ainda não foi processado. Inicie ou aguarde o processamento antes de gerar o relatório de entradas!';
