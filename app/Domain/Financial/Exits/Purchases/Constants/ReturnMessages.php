...
namespace Domain\Financial\Exits\Purchases\Constants;
...
class ReturnMessages
{
    ...
    public const PURCHASE_DELETED = 'Compra excluída com sucesso!';
    ...
    public const PURCHASE_DELETE_ERROR = 'Houve um erro ao excluir esta compra, tente mais tarde!';
