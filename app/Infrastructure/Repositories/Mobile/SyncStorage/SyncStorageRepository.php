...
class SyncStorageRepository extends BaseRepository implements SyncStorageRepositoryInterface
{
    ...
    public function sendToDataServer(SyncStorageData $syncStorageData): SyncStorage
    {
        return $this->create([
            ...
            'account_id'                                    => $syncStorageData->accountId != '0' ? $syncStorageData->accountId : null,
            'origin_account_id'                             => $syncStorageData->originAccountId != '0' ? $syncStorageData->originAccountId : null,
            'destination_account_id'                        => $syncStorageData->destinationAccountId != '0' ? $syncStorageData->destinationAccountId : null,
            'invoice_id'                                    => $syncStorageData->invoiceId != '0' ? $syncStorageData->invoiceId : null,
            ...
            'is_group_devolution'                           => $syncStorageData->isGroupDevolution,
            'is_credit_card_purchase'                       => $syncStorageData->isCreditCardPurchase,
            'closing_day'                                   => $syncStorageData->closingDay,
            'number_installments'                           => $syncStorageData->numberInstallments != '0' ? $syncStorageData->numberInstallments : null,
            ...
            'purchase_description'                          => $syncStorageData->purchaseDescription,
