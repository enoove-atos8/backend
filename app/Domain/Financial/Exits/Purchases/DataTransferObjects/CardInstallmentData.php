    ...
    public static function fromResponse(array $data): self
    {
        return new self(
            ...
            cardPurchaseData: new CardPurchaseData([
                ...
                'establishmentName' => $data['cards_purchases_establishment_name'] != '' ? $data['cards_purchases_establishment_name'] : null,
                'purchaseDescription' => $data['cards_purchases_purchase_description'] != '' ? $data['cards_purchases_purchase_description'] : null,
